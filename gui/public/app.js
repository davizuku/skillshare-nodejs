...
app.formResponseProcessor = function (formId, requestPayload, responsePayload) {
    ...
    if (formId == 'accountCreate') {
        ...
        app.client.request(undefined, '/tokens', 'POST', undefined, newPayload, function (newStatusCode, newResponsePayload) {
            // Display an error on the form if needed
            ...
            if (statusCode == 200) {
                ...
                if (allChecks.length > 0) {
                    ...
                    allChecks.forEach(function (checkId) {
                        ...
                        app.client.request(undefined, '/checks', 'GET', newQueryStringObject, undefined, function (statusCode, responsePayload) {
                            if (statusCode == 200) {
...
app.loadChecksEditPage = function () {
    ...
    if (id) {
        ...
        app.client.request(undefined, '/checks', 'GET', queryStringObject, undefined, function (statusCode, responsePayload) {
            if (statusCode == 200) {
